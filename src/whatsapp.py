...
def send_whatsapp_template(phone: str, template_name: str, components: list = None) -> dict:
    """
    Envia um template via WhatsApp Business API.

    Args:
        phone:          Número no formato internacional sem '+' (ex: 5511999999999).
        template_name:  Nome do template.
        components:     Lista de componentes para o template.
